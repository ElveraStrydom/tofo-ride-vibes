...
const About = ({
  ...
  const content = {
    ...
    pt: {
      ...
      bio: "Jorge é um motorista local confiável baseado em Tofo, Moçambique. Seja uma viagem curta ou longa, você sempre se sentirá seguro e bem-vindo. Conhecido pelo seu sorriso caloroso, pontualidade e profissionalismo, ele ajudou viajantes a explorar a bela costa de Moçambique com segurança e conforto durante anos. Amigável, confiável e sempre pontual, Jorge fala inglês e português fluentemente - e também é um mecânico treinado. Com sua experiência dirigindo veículos 2×4 e 4×4, você está em excelentes mãos. Para muitos viajantes, Jorge é mais do que um motorista - ele é sua conexão local com Moçambique."
    }
  };
